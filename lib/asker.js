...
Request.prototype._processOptions = function(options) {
    ...
    var optKeys = Object.keys(opts), k = 0, key,
        headers = {};
    ...
    if (typeof options === 'object') {
        ...
        if (typeof options.headers === 'object') {
            var optHeaders = Object.keys(options.headers), h = 0;
...
Request.prototype._execute = function() {
    ...
    if (typeof agent === 'object' && typeof agent.addRequest !== 'function') {
        this.options.agent = new AdvancedAgent(assign({ protocol : this.options.protocol }, agent));
    }
