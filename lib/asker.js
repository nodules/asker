...
function Request(options, callback) {
    ...
    if (typeof this.options.body !== 'undefined') {
        if ( ! Object.prototype.hasOwnProperty.call(Request.bodyEncoders, this.options.bodyEncoding)) {
        ...
        process : function(body) {
            ...
            Object.keys(body).forEach(function(name) {
                ...
                if (isFile && attach.filename) {
                    disposition.push('; filename="' + body[name].filename + '"');
                }
