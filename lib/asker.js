...
Request.prototype.compileBody = function() {
    ...
    // @todo for back compat., but looks like fucking elf magic..
    // @todo i think we must up major version, brake compatability and remove this shit
    var bodyType = typeof this.options.body;
    if ( encoderName === 'json' && bodyType !== 'object' ) {
        encoderName = 'string';
    }
