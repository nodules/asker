...
function Request(options, callback) {
    ...
    if (typeof this.options.body !== 'undefined') {
        if ( ! Object.prototype.hasOwnProperty.call(this.bodyEncoders, this.options.bodyEncoding)) {
        ...
        var bodyEncoderType = this.bodyEncoders[this.options.bodyEncoding].type;
        ...
        if ( ! this.options.headers['content-type']) {
            this.options.headers['content-type'] = this.bodyEncoders[this.options.bodyEncoding].header;
        }

        this.options.body = this.bodyEncoders[this.options.bodyEncoding].process(this.options.body);
 ...
 * @type {Object}
 */
Request.prototype.bodyEncoders = {
    text : {
        header : 'text/plain',
        type : 'string',
        ...
        process : function(body) {
            ...
            Object.keys(body).forEach(function(name) {
                ...
                if (isObject) {
                    ...
                    if (isFile || isBuffer) {
                        headerType += ! isBuffer && 'mime' in body[name] ?
                            body[name].mime :
                ...
                if (isObject) {
                    if (isBuffer) {
                        ...
                        data = new Buffer(JSON.stringify(body[name]));
                    }
                } else {
                    data = new Buffer(body[name]);
                }
                bufs.push(data);
